...
const iso8601DateSchema = z
    .string()
    .regex(/^([1-2][0-9]{3}-[0-1][0-9]-[0-3][0-9]|[1-2][0-9]{3}-[0-1][0-9]|[1-2][0-9]{3})$/, "Invalid date format. Use YYYY, YYYY-MM, or YYYY-MM-DD")
    .optional();
...
export { iso8601DateSchema, MetaSchema, LocationSchema, ProfileSchema, BasicsSchema, WorkSchema, VolunteerSchema, EducationSchema, AwardsSchema, CertificateSchema, PublicationsSchema, SkillSchema, LanguagesSchema, InterestsSchema, ProjectSchema, ReferenceSchema, TalksSchema };
