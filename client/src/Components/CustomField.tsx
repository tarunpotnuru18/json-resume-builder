      ...
      <div className="flex flex-col gap-[10px] text-white font-medium text-[14px]">
        ...
        {as === "input" ? (
          <input
            ...
            className="flex items-center h-8 md:h-10 w-full rounded-md border px-3 py-2 text-sm    placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2  focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 border-slate-600 bg-slate-700/95 focus:border-blue-500 focus:ring-blue-500/20 transition-colors"
          />
        ) : (
          <textarea
            value={value}
