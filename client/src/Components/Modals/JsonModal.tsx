...
export default function JsxModal({ setOpen, jsonData, open }) {
          ...
          <div className="w-full flex md:flex-row md:items-center md:gap-[24px] md:justify-between mb-[10px]">
            <div className="flex flex-col justify-center mb-4">
              ...
              <p className="text-xs w-[200px] md:w-fit  md:text-md text-slate-400">
                Copy this JSON data to use with other resume builders
              </p>
            </div>
              ...
              >
                {Copied ? (
                  ...
                  <>
                    ...
                    <span className="hidden md:block">Copy JSON</span>
                  </>
                )}
              </button>
            </div>
